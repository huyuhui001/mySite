...
在组织变革层面，有些公司做了一些有意思的尝试。他们要求所有管理者必须以IC（Individual Contributor，独立贡献者）身份入职。这一硬性标准虽然推高了招聘淘汰率，却从根本上保证了管理层的实战能力。架构上，团队走向极致的扁平化，Pod自治单元打破了固定层级，IC与经理的比例被彻底重构。角色融合的数据也印证了这一趋势：工程师的设计工作占比明显提升，而PM的代码提交量也占了不小的比例。
