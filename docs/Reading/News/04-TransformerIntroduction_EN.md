...
Source: [How Transformers Work: A Detailed Exploration of Transformer Architecture](https://www.datacamp.com/tutorial/how-transformers-work)
...
![Overview](./assets/04-01-Overview.png)
...
In 2020, researchers at OpenAI announced GPT-3. Within weeks, GPT-3's versatility was quickly demonstrated when people were using it to create poems, programs, songs, websites and more captivating the imagination of users globally.
...
![Sample: translator](./assets/04-02-translator.png)
...
![Global structure of Encoder-Decoder](./assets/04-03-Encoder-Decoder.png)
...
![Global structure of Encoder-Decoder Multiple Layers](./assets/04-04-Encoder-DecoderMultipleLayers.png)
...
![Global structure of Encoders](./assets/04-05-EncodersStructure.png)
...
![Encoder’s workflow Input embedding](./assets/04-06-InputEmbedding.png)

#### STEP 2 - Positional Encoding(encoder)
...
![Encoder’s workflow Positional encoding](./assets/04-07-PositionalEncoding.png)
...
![Encoder’s workflow Stack of Encoder Layers](./assets/04-08-StackEncoderLayers.png)
...
![Dot Product of Query and Key](./assets/04-09-QueryKey.png)
...
![Encoder’s workflow Attention mechanism - Matrix Multiplication](./assets/04-10-Multiplication.png)
...
![Encoder’s workflow Reducing the attention scores](./assets/04-11-ReducingAttentionScores.png)
...
![Encoder’s workflow Softmax adjusted scores](./assets/04-12-SoftmaxAdjustedScores.png)
...
![Encoder’s workflow Combining Softmax results with the value vector](./assets/04-13-ValueVector.png)
...
![Encoder’s workflow Normalization and residual connection after Multi-Head Attention](./assets/04-14-Normalization.png)

##### STEP 3.3 Feed-Forward Neural Network(encoder)
...
![Encoder’s workflow Feed-Forward Neural Network sub-layer](./assets/04-15-Feed-Forward.png)
...
![Global structure of Encoders](./assets/04-16-Encoders.png)
...
#### STEP 2 - Positional Encoding(decoder)
...
![Decoder’s workflow First Multi-Head Attention Mask](./assets/04-17-AttentionMask.png)
...
![Decoder’s workflow Encoder-Decoder Attention](./assets/04-18-Encoder-DecoderAttention.png)
...
##### STEP 3.3 Feed-Forward Neural Network(decoder)
...
![Decoder’s workflow Transformer’s final output](./assets/04-19-FinalOutput.png)
...
![Original structure of Transformers](./assets/04-20-TransformersStructure.png)
...
If you are interested to further understand the LaMDA models, you can get a better understanding with the article on LaMDA.
...
If you want to crash into Transformers and their usage, our article on Transformers and Hugging Face is a perfect start! You can also learn how to build a Transformer with PyTorch with our in-depth guide.
