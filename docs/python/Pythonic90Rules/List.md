...
- [第18条 学会利用__missing__构造依赖键的默认值](https://zhuanlan.zhihu.com/p/1894029993954223982)
- [第19条 不要把函数返回的多个数值拆分到三个以上的变量中](https://zhuanlan.zhihu.com/p/1894375754348869083)
- [第20条 遇到意外状况时应该抛出异常,不要返回None](https://zhuanlan.zhihu.com/p/1895153333896992367)
